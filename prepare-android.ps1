...
$uiPatchFile = Join-Path $wwwDirectory 'js\app-ui-patch-v1.js'
...
if (-not (Test-Path -LiteralPath $uiPatchFile)) {
    throw "UI patch skripta ni najdena: $uiPatchFile"
}
...
$scriptTags = @(
    ...
    '<script src="js/app-ui-patch-v1.js"></script>'
)
