# Workout Tracker 1.2.0 — Molten UI
...
2. Prenesi [APK izdaje 1.2.0](https://github.com/ragnarokdrakkar-rgb/GYM/releases/download/v1.2.0/Workout-Tracker-v1.2.0.apk) ali odpri [GitHub Releases](https://github.com/ragnarokdrakkar-rgb/GYM/releases/latest).
3. Odpri APK in izberi **Posodobi**. Stare aplikacije ne odstranjuj in ne briši njenih podatkov.

Identiteta paketa ostaja `com.kemal.workouttracker`; versionCode izdaje 1.2.0 je 63. APK mora biti podpisan z istim obstoječim ključem. Ključ in njegove nastavitve niso del repozitorija.
...
- Podrobnosti: `RELEASE_NOTES_1.2.0.md`. versionCode 63.
