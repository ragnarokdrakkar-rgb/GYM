/* Workout Tracker service worker v1.3.2 */
const CACHE_NAME = 'workout-tracker-v1.3.2-quick-training';
const CORE_FILES = [
  './',
  './index.html',
  ...
  './assets/fonts/barlow-condensed-latin-ext-600-normal.woff2',
  './assets/fonts/barlow-condensed-latin-ext-700-normal.woff2',
  './vendor/chart.umd.js',
  './manifest.json',
  './icon-192.png',
  './icon-512.png'
